...
import { Globe, AlertCircle, CheckCircle, AlertTriangle } from 'lucide-react';
...
export const APIGatewayNode = memo(({ data, selected, id }: NodeProps) => {
  ...
  const getStatusBorder = () => {
    switch (status.status) {
      ...
      default:
        return 'border-border hover:border-node-gateway/50';
    }
  };
